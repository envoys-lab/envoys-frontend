...
import { Text, EnvoysToggle, Toggle, Flex, Modal, InjectedModalProps, ThemeSwitcher } from '@envoysvision/uikit'
import {
  useAudioModeManager,
      ...
      <ScrollableContainer>
        ...
        <Flex justifyContent="space-between" alignItems="center">
          <Flex alignItems="center">
            ...
            <QuestionHelper
              text={t('Fun sounds to make a truly immersive envoys-flipping trading experience')}
              placement="top-start"
              ml="4px"
            />
          </Flex>
          <EnvoysToggle checked={audioPlay} onChange={toggleSetAudioMode} scale="md" />
        </Flex>
      </ScrollableContainer>
    </Modal>
  )
