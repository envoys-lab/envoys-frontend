      ...
      <ScrollableContainer>
        <Flex flexDirection="column" mb="8px">
          <Flex paddingBottom="8px">
            <Text color="primary" bold fontSize="12px" paddingRight="4px" textTransform="uppercase">
              {stakingTokenSymbol}
            </Text>
          ...
          <Text mt="24px" color="text" bold fontSize="12px" textTransform="uppercase">
            {t('Staked for')}
          </Text>
