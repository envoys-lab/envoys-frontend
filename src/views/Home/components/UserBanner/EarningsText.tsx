...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and EVT pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and EVT pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from EVT pool', data)
  }
