...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@envoysvision/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in EVT prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with EVT, win EVT if your numbers match')}
        </Text>
      </Flex>
