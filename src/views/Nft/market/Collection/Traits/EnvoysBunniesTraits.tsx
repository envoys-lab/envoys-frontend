...
import { Skeleton, Table, Td, Th, Flex, ArrowUpIcon, ArrowDownIcon } from '@envoysvision/uikit'
...
interface EnvoysBunniesTraitsProps {
...
const EnvoysBunniesTraits: React.FC<EnvoysBunniesTraitsProps> = ({ collectionAddress }) => {
...
export default EnvoysBunniesTraits
