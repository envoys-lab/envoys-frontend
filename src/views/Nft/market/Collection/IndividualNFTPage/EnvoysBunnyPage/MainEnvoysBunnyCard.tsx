...
import { Flex, Box, Card, CardBody, Text, Button, BinanceIcon, Skeleton, useModal } from '@envoysvision/uikit'
...
interface MainEnvoysBunnyCardProps {
  cheapestNft: NftToken
  cheapestNftFromOtherSellers?: NftToken
  nothingForSaleBunny?: NftToken
}

const MainEnvoysBunnyCard: React.FC<MainEnvoysBunnyCardProps> = ({
  cheapestNft,
...
export default MainEnvoysBunnyCard
