...
interface ManageEnvoysBunniesCardProps {
  bunnyId: string
  lowestPrice?: string
}

const ManageEnvoysBunniesCard: React.FC<ManageEnvoysBunniesCardProps> = ({ bunnyId, lowestPrice }) => {
  const { t } = useTranslation()
...
export default ManageEnvoysBunniesCard
