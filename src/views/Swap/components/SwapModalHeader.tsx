...
export default function SwapModalHeader({
  ...
  return (
    <AutoColumn gap="md">
      {false && (<RowBetween align="flex-end">
        <RowFixed gap="0px">
      ...
      <Card justify="center" position={"relative"} padding={0}>
        <CurrencyInputPanel
      ...
      <Box m={0}>
          ...
          {showAcceptChanges ? (
              <SwapShowAcceptChanges justify="flex-start" gap="0px">
                  <RowBetween>
                      <RowFixed>
                          <Text color={"primary"} fontWeight={500}> {t('Price Updated')}</Text>
                      </RowFixed>
                      <Button scale={"md"} onClick={onAcceptChanges}>{t('Accept')}</Button>
                  </RowBetween>
