...
import { Box, Button, Card, CardBody, Flex, Step, Stepper, Text } from '@envoysvision/uikit'
    ...
    <StyledEventStepsSectionContainer justifyContent="center" $isDark={isDark}>
      ...
      <StyledWaveContainer bottom="-3px">
        <Flex justifyContent="center">
          <StyledBunniesSquadImg src="/images/pancakeSquad/squadRow.png" alt="envoys bunnies squad" />
        </Flex>
