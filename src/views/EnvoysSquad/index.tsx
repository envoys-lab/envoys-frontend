...
import EnvoysSquadHeader from './components/Header'
import { EnvoysSquadContext } from './context'
...
const EnvoysSquad: React.FC = () => {
  ...
  return (
    <EnvoysSquadContext.Provider value={{ isUserEnabled, setIsUserEnabled }}>
    ...
    </EnvoysSquadContext.Provider>
  )
}

export default EnvoysSquad
