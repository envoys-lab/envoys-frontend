...
import { Button, useModal } from '@envoysvision/uikit'
...
import { EnvoysSquadContext } from 'views/EnvoysSquad/context'
...
const BuyTicketsButtons: React.FC<BuyTicketsProps> = ({
  ...
  const { isUserEnabled, setIsUserEnabled } = useContext(EnvoysSquadContext)
