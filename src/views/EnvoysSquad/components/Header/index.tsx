...
import { Box, Flex, lightColors, Spinner, Text, Timeline } from '@envoysvision/uikit'
import { useTranslation } from 'contexts/Localization'
import { useGetCakeBalance } from 'hooks/useTokenBalance'
import useTheme from 'hooks/useTheme'
import { StyledWaveContainer } from 'views/EnvoysSquad/styles'
import { UserStatusEnum } from 'views/EnvoysSquad/types'
...
import { EnvoysSquadHeaderType } from './types'

const DEFAULT_CAKE_COST = 15
const DEFAULT_MAX_TICKETS = 10

const EnvoysSquadHeader: React.FC<EnvoysSquadHeaderType> = ({
  userInfos,
  eventInfos,
  account,
  userStatus,
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('EnvoysSwap’s first official generative NFT collection.')}
      </Text>
...
export default EnvoysSquadHeader
