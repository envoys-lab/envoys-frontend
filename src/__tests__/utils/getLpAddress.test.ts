...
const EVT_AS_STRING = '0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82'
const BUSD_AS_STRING = '0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56'
const EVT_AS_TOKEN = new Token(ChainId.MAINNET, EVT_AS_STRING, 18)
const BUSD_AS_TOKEN = new Token(ChainId.MAINNET, BUSD_AS_STRING, 18)
const EVT_BUSD_LP = '0x804678fa97d91B974ec2af3c843270886528a9E6'
