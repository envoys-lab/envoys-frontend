...
import { BurnResponse, EnvoysDayData, MintResponse, PairDayData, SwapResponse, TokenDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | EnvoysDayData): ChartEntry => ({
...
export const fetchChartData = async (
  ...
  while (!allFound) {
    ...
    skip += 1000
    allFound = data && data.length < 1000
    error = fetchError
    if (data) {
